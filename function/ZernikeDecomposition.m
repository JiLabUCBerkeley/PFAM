function zernikeCoeff = ZernikeDecomposition(wavefront, centerPos, pupilSize)

% wavefront = wavefront - mean(wavefront(:));
wfInPupil = wavefront(centerPos(2)-pupilSize/2:centerPos(2)+pupilSize/2,...
                    centerPos(1)-pupilSize/2: centerPos(1)+pupilSize/2);
ImSize = size(wfInPupil, 1);
[xx, yy] = meshgrid(1:ImSize);
xx = xx - pupilSize/2;
yy = yy - pupilSize/2;
wfInPupil(xx.^2+yy.^2 > pupilSize^2/4) = 0;
